...
THREAT_T_HOSTILE, MONSTER_T_CAT, 1, 4, 12, 12, 12, 12, 12, 12, \
ENTITYPATHFINDINGALGORITHM_T_FOLLOW_PC_STRICT, ENTITYITEMPICKUPALGORITHM_T_NONE, 4, nil))

#define FireCat (Monster(@"Cat", PREFIX_T_FIRE, \
THREAT_T_HOSTILE, MONSTER_T_CAT, 1, 4, 12, 12, 12, 12, 12, 12, \
ENTITYPATHFINDINGALGORITHM_T_FOLLOW_PC_STRICT, ENTITYITEMPICKUPALGORITHM_T_NONE, 4, nil))

#define IceCat (Monster(@"Cat", PREFIX_T_ICE, \
THREAT_T_HOSTILE, MONSTER_T_CAT, 1, 4, 12, 12, 12, 12, 12, 12, \
ENTITYPATHFINDINGALGORITHM_T_FOLLOW_PC_STRICT, ENTITYITEMPICKUPALGORITHM_T_NONE, 4, nil))

#define WaterCat (Monster(@"Cat", PREFIX_T_WATER, \
THREAT_T_HOSTILE, MONSTER_T_CAT, 1, 4, 12, 12, 12, 12, 12, 12, \
ENTITYPATHFINDINGALGORITHM_T_FOLLOW_PC_STRICT, ENTITYITEMPICKUPALGORITHM_T_NONE, 4, nil))

#define EarthCat (Monster(@"Cat", PREFIX_T_EARTH, \
THREAT_T_HOSTILE, MONSTER_T_CAT, 1, 4, 12, 12, 12, 12, 12, 12, \
ENTITYPATHFINDINGALGORITHM_T_FOLLOW_PC_STRICT, ENTITYITEMPICKUPALGORITHM_T_NONE, 4, nil))

#define LightningCat (Monster(@"Cat", PREFIX_T_LIGHTNING, \
THREAT_T_HOSTILE, MONSTER_T_CAT, 1, 4, 12, 12, 12, 12, 12, 12, \
ENTITYPATHFINDINGALGORITHM_T_FOLLOW_PC_STRICT, ENTITYITEMPICKUPALGORITHM_T_NONE, 4, nil))

#define WeakCat (Monster(@"Cat", PREFIX_T_WEAK, \
THREAT_T_HOSTILE, MONSTER_T_CAT, 1, 4, 12, 12, 12, 12, 12, 12, \
ENTITYPATHFINDINGALGORITHM_T_FOLLOW_PC_STRICT, ENTITYITEMPICKUPALGORITHM_T_NONE, 4, nil))

//====================

#define Dragon (Monster(@"Dragon", PREFIX_T_NONE, \
THREAT_T_HOSTILE, MONSTER_T_DRAGON, 1, 20, 16, 16, 16, 16, 16, 16, \
ENTITYPATHFINDINGALGORITHM_T_FOLLOW_PC_STRICT, ENTITYITEMPICKUPALGORITHM_T_NONE, 4, nil))

//====================
#define Treant (Monster(@"Treant", PREFIX_T_NONE, \
THREAT_T_HOSTILE, MONSTER_T_TREANT, 1, 12, 12, 12, 12, 12, 12, 12, \
ENTITYPATHFINDINGALGORITHM_T_FOLLOW_PC_STRICT, ENTITYITEMPICKUPALGORITHM_T_NONE, 8, nil))
