...
-( id ) initWithColor:(ccColor4B)color width:(GLfloat)w height:(GLfloat)h {
    if ( ( self = [ super initWithColor: color width: w height: h ] ) ) {
        ...
        menuItemStatus.position = ccp( 0 + menuItemStatus.contentSize.width/2, h - 32-32 - 5*2);
        ...
        menuItemInventory.position = ccp( 0 + menuItemInventory.contentSize.width/2, h - 32-32-32 - 5*3 );
